...
let
  ...
  wgInterfaceCfg = {
    ...
    address = [
      (infra.ipAddressMasked deviceCfg.wireguard.internal.ipv4 intranetCfg.wireguard.internal.ipv4.mask)
      (infra.ipAddressMasked deviceCfg.wireguard.internal.ipv6 intranetCfg.wireguard.internal.ipv6.mask)
    ];
  };
  ...
  peerCommonCfg = {
    ...
    endpoint = "${serverCfg.external.wan.ipv4}:${builtins.toString serverCfg.wireguard.internal.port}";
  };
in
{
